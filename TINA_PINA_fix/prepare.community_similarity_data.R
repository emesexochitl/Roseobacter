...
################################################################################
################################################################################
# ESZ: invoke funtions script to update processes in ape, pyloseq ..
source("functions.community_similarity_update.R", echo=TRUE) 
...
PARAM$folder.output <- "test/" #PUT RESULTS/OUTPUT FOLDER HERE
